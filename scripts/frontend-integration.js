 ...
 * This file demonstrates how to integrate Smartvault with a web frontend
 */

// For React/Vue/Angular applications
export class SmartvaultClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SmartvaultClient(provider, contractAddress);
